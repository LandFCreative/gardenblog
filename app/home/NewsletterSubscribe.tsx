...
const NewsletterSubscribe = (props: Props) => {
  ...
  if (subscribed) return (
    <div className='flex flex-col mt-4 text-white'><h2 className='text-2xl'>Thank you for subscribing!</h2>
    <p>You&apos;ll receive the latest tech news and announcements in your inbox.
      </p>
      </div>
  )
